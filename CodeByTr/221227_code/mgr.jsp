...
<body onLoad="pageInit('${param.message}', '${AccessInfo.storeInfoList[0].empList[0].accessList[0].accessDate }')">
	...
	<script>
		const itemCode = [[ "매출분석", "종합분석", "매출 종합 분석", "" ],
				...
				[ "S", "상품상태", "상품 상태 코드 관리", ["GetGoodsCategoryList"], ["InsGoodsState", "levName"], ["UpdGoodsState", 1, "상품상태명"]],
				[ "L", "직원등급", "직원 등급 코드 관리", ["GetGoodsCategoryList"], ["InsEmpLev", "levName"], ["UpdEmpLev", 1, "직원등급명"]],
				[ "D", "가격분류", "상품 가격 코드 관리", ["GetGoodsCategoryList"], ["InsPriceCategory", "levName"], ["UpdPriceCategory", 1, "가격타입명"]],
				[ "Z", "구역분류", "판매 구역 코드 관리", ["GetGoodsCategoryList"], ["InsZone", "levName"], ["UpdZone", 1, "매장구역명"]],
				[ "O", "주문상태", "주문 상태 코드 관리", ["GetGoodsCategoryList"], ["InsOrderState", "levName"], ["UpdOrderState", 1, "주문상태명"]],
				[ "P", "결제상태", "결제 상태 코드 관리", ["GetGoodsCategoryList"], ["InsPaymentState", "levName"], ["UpdPaymentState", 1, "결제상태명"]],
		...
		function serverCall() {
			...
			form.setAttribute("action", itemCode[recordIdx][jobIndex][0]);
		...
		/* 새로고침 막기 */
		function refreshingDefender(event){
			alert("");
