...
<body onLoad="pageInit('${message}', '${AccessInfo.storeInfoList[0].empList[0].accessList[0].accessDate }')">
	<div id="wrap">
		<div id="side">
			<div id="store">
					${options}
	...
	<script>
		...
		function serverCall(storeCode, itemCode, objIdx){
