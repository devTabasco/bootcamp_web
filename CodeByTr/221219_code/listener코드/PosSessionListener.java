...
public class PosSessionListener implements HttpSessionListener, HttpSessionIdListener, HttpSessionBindingListener, HttpSessionAttributeListener {
	...
	public void sessionDestroyed(HttpSessionEvent sessionEvent) {
		...
		System.out.println(((GroupBean)sessionEvent.getSession().getAttribute("AccessInfo")).getStoreInfoList().get(0).getStoreCode());
		Auth auth = new Auth();
		auth.backController(999, ((GroupBean)sessionEvent.getSession().getAttribute("AccessInfo")).getStoreInfoList().get(0));
	}
