								...
								<div class="card-body p-md-5 mx-md-4">
									...
									<div class="text-center">
										<a href="index.jsp"
											...
											<h2 class="mt-1 mb-5 pb-1">Make Your Resume</h2></a>
									</div>
									...
									<form>
										...
										<div id="joinDataLayer">
											<div class="form-outline mb-4">
												<input type="email" id="form2Example11" class="form-control"
													placeholder="핸드폰 번호 또는 이메일을 입력하세요." name="memberEmail" />
											</div>
										...
										<div class="text-center">
											<button class="btn btn-primary gradient-custom-2"
												type="button" style="width: 100%" onClick="login()">로그인</button>
										</div>

										<div
											class="d-flex align-items-center justify-content-center pb-4">
											<p class="mb-0 me-2">아직 계정이 없으신가요?</p>
											<a href="createAccount.jsp"><button type="button"
													class="btn btn-outline-danger">계정 생성</button></a>
										</div>
									</form>
