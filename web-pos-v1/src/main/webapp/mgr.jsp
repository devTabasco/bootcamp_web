	...
	<script>
		...
		function showInputBox(itemIdx){
			...
			for(idx=0; idx<itemCode[itemIdx][5][1][0]; idx++){
				const input = createInputBox("text", itemCode[itemIdx][5][1][1], "", itemCode[itemIdx][5][1][2]);
				input.setAttribute("class", "box big");
			...
			commandZone.style.width = (itemCode[itemIdx][5][1][0] > 3)? "80vw":"50vw";
			commandZone.style.height = (itemCode[itemIdx][5][1][0] * 30) + "%";
			inputZone.style.width = (itemCode[itemIdx][5][1][0] > 3)? "60%" : "30%";
			/* background zone */
