...
<head>
<meta charset="UTF-8">
<title>Member Join :: Group Step 2</title>
...
<body onLoad="pageInit('${message}')">
	<div id="header">
		...
		<div id="currentPage">[ Join ]<span class="nav small">▶▶▶</span>[ Group Step 1 ]<span class="nav small">▶▶▶</span><span class="nav big">[ Group Step 2 ]</span></div>
	</div>
	<div id="content"></div>
	<div id="footer">
		<div class="btn tripple on" onClick="registration()">NEXT</div>
		<div class="btn tripple off" onClick="movePage('${previous }')">PREVIOUS</div>
