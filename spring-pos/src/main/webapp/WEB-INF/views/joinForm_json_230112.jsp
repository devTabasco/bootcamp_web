...
<head>
<meta charset="UTF-8">
<title>Member Join Json :: Group Step 1</title>
...
<script>
document.getElementsByClassName('inputZone')[2].children[0].onblur = function(){
	let formData = new FormData();
	formData.append("storeInfoList[0].storeCode",document.getElementsByClassName('inputZone')[2].children[0].value);	
	serverCallByFetchAjax(formData, "StoreCodeChk", "post", 'isStoreCode');
}
</script>
</html>